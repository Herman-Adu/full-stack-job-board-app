    ...
    return (
        <div className="container">
            <h2 className="text-lg mt-6">Create a new company</h2>
                <p className="text-gray-500 text-sm mb-4">To create a job listing, you first need to register a new company</p>                    
                <form 
                ...
                >                        
                    ...
                    />
                    <button type="submit" className="flex gap-2 items-center bg-gray-300 px-4 py-2 rounded-md">
                        Create a company 
                    </button>
                </form>   
        </div>
